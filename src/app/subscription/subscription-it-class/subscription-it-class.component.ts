...
@Component({
  selector: "app-subscription-it-class",
  templateUrl: "./subscription-it-class.component.html",
  styleUrls: ["./subscription-it-class.component.scss"],
})
export class SubscriptionItClassComponent implements OnInit, OnDestroy {
  focus1: boolean;
  focus2: boolean;
  trialForm: FormGroup;
